    ...
    return (
      <div className="hidden z-[999] fixed w-[90%] md:w-[50rem] xs:flex flex-row justify-between items-center px-4 py-2 mt-4 md:mt-6 rounded-md bg-white/60 dark:bg-[#12181d]/60 border border-slate-800/50 backdrop-blur-lg">
        ...
        <div className="flex flex-row items-center justify-center gap-2 xs:gap-4">
          <div className="" style={{display: "inline"}} data-tooltipped="" aria-describedby="tippy-tooltip-1" data-original-title="GitHub">
          ...
          <div className="" style={{display: "inline"}} data-tooltipped="" aria-describedby="tippy-tooltip-2" data-original-title="Twitter">
          ...
          <div className="" style={{display: "inline"}} data-tooltipped="" aria-describedby="tippy-tooltip-3" data-original-title="Email">
